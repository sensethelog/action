...
async function createFixPR(token, analysis, context) {
  ...
  const fixBranch = `sensethelog-fix/${context.sha.substring(0, 7)}`;
  ...
  try {
    ...
    const { data: pr } = await octokit.rest.pulls.create({
      ...
      body: `## Auto-generated Fix by SenseTheLog
...
*Generated by [SenseTheLog](https://sensethelog.com)*`,
      head: fixBranch,
      base: baseBranch,
    });
